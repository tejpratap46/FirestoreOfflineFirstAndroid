...
class FirestoreOfflineManager {
    ...
    fun initialiseSyncMaster(
        ...
        var firestoreSyncMaster: FirestoreSyncMaster? =
            firesoreRoomManager!!.firestoreSyncMasterDao()
                .getSyncMasterByCollectionName(collectionName = collectionName)
     ...
     *
     * @param collectionName table/collection Name
     * @param localId id from your local DB
     * @param documentToSave data to be saved, should implement FirebaseOfflineDocument interface
    ...
    fun <T : FirebaseOfflineDocument> addData(
        ...
        val syncTrackerId: String = FirestoreSyncTracker.generateId(localId, documentReference)
        val createdOn: Long = System.currentTimeMillis()
        val updatedOn: Long = System.currentTimeMillis()
        val updatedBy: String = firestoreLocalSettings!!.deviceId
        ...
        var firestoreSyncTracker: FirestoreSyncTracker? =
            firesoreRoomManager!!.firestoreSyncTrackerDao()
                .getSyncTrackerById(collectionName = collectionName, synTrackerId = syncTrackerId)
